function getData(numOfRows) {
  ...
  for (let i = 0; i < numOfLoops; i++) {
    sample.forEach(item => {
      ...
      rs.push({
        "EmployeeID":counter++,jobTitle: item.jobTitle + i, employmentType: employmentType, orgHierarchy: newHierarchy, 'mon': monVal, 'tue': random(100), 'wed': random(100), 'thu': random(100), 'fri': random(100), 'sat': random(100), 'sun': random(100), 'percentage': "50%"
      });
    })
  }
